...
//
// src/virtual_catalog/include/bridge_pushdown.hpp is the SQL analogue and shares FilterFidelity with
// this file, so the two cannot drift on what may be dropped; keep the type dispatch in step.
