...
//
// Deliberately not used for the serve-reactor registry (src/n6k_server/serve_reactor.cpp): that one
// is non-owning, holds several values per key, and is scoped by an RAII guard instead.
