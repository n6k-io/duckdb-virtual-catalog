...
function boot(): void {
  ...
  const parentOrigin = globalThis.__PARENT_ORIGIN;
  if (!parentOrigin) throw new Error("missing injected __PARENT_ORIGIN");
  createRoot(el).render(
    <QueryProvider>
      <IFrameDuckDBProvider parentOrigin={parentOrigin}>
        <Probe />
